                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <div class="slide-content row text-center">
                            <div class="col-12 mx-auto inner">
                                <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">Express what you stand for
                    ...
                    <main class="col-12 col-md-12 p-0">
                        ...
                        <div class="row">
                            <div class="col-12 align-self-center">
                                ...
                                <div class="gallery">
                                    <a >
                                        <img src="/assets/images/services-featured-image/branding.jpg" class="w-100">
                                    </a>
                                </div>
                            ...
                            <div class=" col-12 col-sm-6">
                                <div class="gallery row justify-content-center">
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/1.png" class="w-100">
                                    </a>
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/2.png" class="w-100">
                                    </a>
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/3.png" class="w-100">
                                    </a>
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/4.png" class="w-100">
                                    </a>
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/5.png" class="w-100">
                                    </a>
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/6.png" class="w-100">
                                    </a>
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/7.png" class="w-100">
                                    </a>
                                    <a class="col-sm-3 item" >
                                        <img src="/assets/images/services-icons-tech/design/8.png" class="w-100">
                                    </a>
                                </div>
                            </div>
