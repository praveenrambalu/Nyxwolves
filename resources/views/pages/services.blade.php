            ...
            <div class="container">
                <div class="row intro">
                    ...
                    <div class="col-12 col-md-3 align-self-end">
                        <a href="services.html" class="btn mx-auto mr-md-0 ml-md-auto primary-button"><i class="icon-grid"></i>VIEW ALL</i></a>
                    </div>
                </div>
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-6 item">
                        <div class="card featured left">
                            ...
                            <a href="service-brand-and-identity.html"><i class="btn-icon icon-arrow-right-circle"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6 item">
                        <div class="card">
                            ...
                            <a href="service-web-design-and-development.html"><i class="btn-icon icon-arrow-right-circle"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6 item">
                        <div class="card">
                            ...
                            <a href="service-digital-marketing.html"><i class="btn-icon icon-arrow-right-circle"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6 item">
                        <div class="card featured right">
                            ...
                            <a href="service-ai-digital-platforms.html"><i class="btn-icon icon-arrow-right-circle"></i></a>
                        </div>
                    </div>
