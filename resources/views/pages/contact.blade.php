...
@keyframes bounce {
    ...
    <body>
      ...
      @include('inc.header')
        ...
        <!-- Banner -->
        <section id="slider" class="p-0 featured odd" style="background:linear-gradient(45deg,#00000012,#000000c4),url(/assets/images/banners/contact-us.jpg);  background-size:cover; background-repeat:no-repeat;">
